...
if __name__ == "__main__":
    ...
    parse.add_argument("--input_path", type = str, default = './', help = 'path to the input noisy frames.')
    parse.add_argument("--output_path", type =  str, default= ' ./', help = 'path to save the denoised frames.')
